...
namespace ASPNETAPITheStep.Migrations
{
    ...
    [Migration("20240428105251_user_accounts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNETAPITheStep.Models.BankBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASPNETAPITheStep.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ASPNETAPITheStep.Models.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ASPNETAPITheStep.Models.Employee", b =>
                {
                    b.HasOne("ASPNETAPITheStep.Models.BankBranch", "BankBranch")
                        .WithMany("Employees")
